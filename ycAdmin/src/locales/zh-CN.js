...
export default {
  ...
  "menu.userpage": "用户页",
  "menu.userpage": "用户管理",
  "menu.userpage.information": "用户管理",
  "menu.article": "文章管理",
  "menu.article.articlelist": "文章列表",
  "menu.article.addingarticle": "添加文章",
  "menu.article.editingarticle": "编辑文章",
  "menu.picture": "轮播图管理",
  "menu.picture.carousel": "轮播图",
  "menu.form": "表单页",
  ...
  "menu.account": "个人页",
  "menu.account.center": "动态",
  "menu.account.settings": "文章动态",
  ...
  "app.test.test": "工专路 {no} 号店",
  "app.test.introduce": "指标说明",
  "app.test.total-sales": "总销售额",
  "app.test.day-sales": "日销售额",
  "app.test.visits": "访问量",
  "app.test.visits-trend": "访问量趋势",
  "app.test.visits-ranking": "门店访问量排名",
  "app.test.day-visits": "日访问量",
  "app.test.week": "周同比",
  "app.test.day": "日同比",
  "app.test.payments": "支付笔数",
  "app.test.conversion-rate": "转化率",
  "app.test.operational-effect": "运营活动效果",
  "app.test.sales-trend": "销售趋势",
  "app.test.sales-ranking": "门店销售额排名",
  "app.test.all-year": "全年",
  "app.test.all-month": "本月",
  "app.test.all-week": "本周",
  "app.test.all-day": "今日",
  "app.test.search-users": "搜索用户数",
  "app.test.per-capita-search": "人均搜索次数",
  "app.test.online-top-search": "线上热门搜索",
  "app.test.the-proportion-of-sales": "销售额类别占比",
  "app.test.channel.all": "全部渠道",
  "app.test.channel.online": "线上",
  "app.test.channel.stores": "门店",
  "app.test.sales": "销售额",
  "app.test.traffic": "客流量",
  "app.test.table.rank": "排名",
  "app.test.table.search-keyword": "搜索关键词",
  "app.test.table.users": "用户数",
  "app.test.table.weekly-range": "周涨幅",
